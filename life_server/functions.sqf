...
private[""_msg"",""_to""];
	...
	[] call life_fnc_cellphone;
	hint format[""Du hast allen ADAC Mitgliedern eine SMS geschrieben."",_to,_msg];
	ctrlShow[3022,true];
";
//To One Person
fnc_cell_textmsg =
...
compileFinal "
	...
	switch (_type) do
	{
		...
		case 6: {
			private[""_message""];
			_message = format[""!!!ADAC Auftrag: %1"",_msg];
			hint parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>ADAC Auftrag<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>You<br/><t color='#33CC33'>From: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%2"",_from,_msg];
			
			[""TextMessage"",[format[""ADAC Auftrag von %1"",_from]]] call bis_fnc_showNotification;
		};
	};
";
