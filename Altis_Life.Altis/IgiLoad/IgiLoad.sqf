...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Quadbike = ["I_Quadbike_01_F", "C_Quadbike_01_F", "O_Quadbike_01_F", "B_G_Quadbike_01_F", "B_Quadbike_01_F", "CAF_Quadbike_OD", "CAF_Quadbike_AR", "Marinir_Quadbike_01_FG","C_Kart_01_F"];  //Kart
	...
	IL_Supported_Cargo_Kamaz = IL_Supported_Cargo_Veh_Kamaz;
	...
	IL_Supported_Cargo_HEMTT = IL_Supported_Cargo_Veh_HEMTT;
	...
	IL_Supported_Cargo_TEMPEST = IL_Supported_Cargo_Veh_TEMPEST;
...
//	END IL_Vehicle_Chat
	...
	IL_Move_Attach=
	{
	if(playerSide != east) exitWith {_kill =  "Du gehörst nicht zum ADAC!"};
		...
		{
			{
				...
				else
				{
					...
					{
						[_v, Format ["Aufladen ""%1"" auf ""%2"" startet", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")]] call IL_Vehicle_Chat;
						_done = true;
						_counter = (_box_num);
						...
						{
							[_v, Format ["""%1"" wurde aufgeladen auf ""%2"". Freie Plätze: ""%3"".", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName"), abs(_slot_num - _counter)]] call IL_Vehicle_Chat;
						}
						else
						{
							[_v, Format ["""%1"" wurde aufgeladen auf ""%2"" Keine weiteren Plätze.", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")]] call IL_Vehicle_Chat;
						};
					}
					else
					{
		...
		{
			{
				...
				if (_x getVariable "doors" == _doors) then
				{
					...
					{
						[_v, Format ["Abladen ""%1"" vom ""%2"" startet", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")]] call IL_Vehicle_Chat;
						_done = true;
						_skip = false;
						_zload = (_v getVariable "zload") + (_x getVariable "zload_cargo");
						_cargo_offset = (_v getVariable "cargo_offset") + (_x getVariable "cargo_offset");
						...
						[_v, Format ["""%1"" wurde abgeladen von ""%2"". Freie Plätze: ""%3"".", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName"), _free_slots]] call IL_Vehicle_Chat;
						sleep 1;
					};
				};
				if (_done) exitWith {};
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fahrzeug abladen vom CH-49</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Aufladen einschalten für Co-Pilot</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Aufladen ausschalten für Co-Pilot</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Von ausserhalb Laden einschalten</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Von ausserhalb Laden ausschalten</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_CHINOOK) then
{
	...
	if (typeOf _obj_main == "CH_147F") then
	{
		...
		_obj_main addAction [
		"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf Chinook</t>",
		{
		...
		_obj_main addAction [
		"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fahrzeug abladen vom Chinook</t>",
		{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Aufladen von ausserhalb einschalten</t>",
	{
		(_this select 0) setVariable["can_outside", true, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"(((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot'))) && !(_target getVariable 'can_outside') && IL_Can_Outside)"
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Aufladen von ausserhalb ausschalten</t>",
	{
		(_this select 0) setVariable["can_outside", false, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"(((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot'))) && (_target getVariable 'can_outside') && IL_Can_Outside)"
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Einschalten Rampe</t>",
	{
		(_this select 0) setVariable["usable_ramp", true, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"(((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot'))) && !(_target getVariable 'usable_ramp') && IL_Ramp)"
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Ausschalten Rampe</t>",
	{
		(_this select 0) setVariable["usable_ramp", false, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"(((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot'))) && (_target getVariable 'usable_ramp') && IL_Ramp)"
...
if (_obj_main_type in IL_Supported_Vehicles_C130J) then
{
	...
	{
		_obj_main addAction [
		"<t color=""#ff0000"">Gehe aus dem Bereich der Rampe</t>",
		{
			[_this select 0, _this select 1, false] call IL_GetOut;
		},[],IL_Action_LU_Priority,false,true,"",
...
//		"('Cargo' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (((getPosATL _target) select 2) >= IL_Para_Jump_ATL) && (_target animationPhase 'ramp_bottom' < 0.1) && (_target getVariable 'usable_ramp')"
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf C-130J</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fahrzeug abladen vom C-130J</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_C17) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf C17</t>",
	{
		[_this select 0, IL_Supported_Cargo_C17] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fahrzeug abladen vom C17</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_MH9) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fahrzeug abladen vom MH-9</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_OFFROAD) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf Offroad</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fahrzeug abladen vom Offroad</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_VAN) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fahrzeug abladen vom VAN</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_KAMAZ) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fahrzeug abladen vom ZAMAK</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_TEMPEST) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf TEMPEST</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fahrzeug abladen vom TEMPEST</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fahrzeug abladen vom HEMTT</t>",
	{
