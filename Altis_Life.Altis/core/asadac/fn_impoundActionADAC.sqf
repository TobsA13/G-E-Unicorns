...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	[[0,format["%1 dein %2 wird vom ADAC abgeschleppt",(_vehicleData select 0) select 1,_vehicleName]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	if((count crew _vehicle) == 0) then
	{
		...
		[[0,format["%2 dein %3 wurde von %1 abgeschleppt!",player getVariable["realname",name player],(_vehicleData select 0) select 1,_vehicleName]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
