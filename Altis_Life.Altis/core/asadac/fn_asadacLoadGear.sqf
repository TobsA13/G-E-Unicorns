...
_itemArray = asadac_gear;
waitUntil {!(isNull (findDisplay 46))};

if(isNil "_itemArray") exitWith {[] call life_fnc_asAdacDefault;}; //Slot data doesn't exist
if(count _itemArray == 0) exitWith {[] call life_fnc_asAdacDefault;}; //Slot data doesn't exist
