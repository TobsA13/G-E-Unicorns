...
switch (playerSide) do
{
	...
	{	
		//Houses
        life_actions = life_actions + [player addAction["<t color='#000FF'>Toggle House Locks</t>",life_fnc_lockHouse,cursorTarget,10,false,false,"",
        ...
        ' !isNull cursorTarget && (player distance cursorTarget) < 20 && cursorTarget isKindOf "House" && license_civ_home && (getPlayerUID player) in (cursorTarget getVariable["life_homeOwners", []])']];
        life_actions = life_actions + [player addAction["<t color='#FF00'>Save House</t>",life_fnc_saveHouse,cursorTarget,10,false,false,"",
        ' !isNull cursorTarget && (player distance cursorTarget) < 20 && cursorTarget isKindOf "House" && license_civ_home && (getPlayerUID player) in (cursorTarget getVariable["life_homeOwners", []])']];
        ...
        ' !isNull cursorTarget && (player distance cursorTarget) < 6 && cursorTarget isKindOf "House"  && speed cursorTarget < 2 && (count (cursorTarget getVariable["containers", []]) > 0) && ((cursorTarget getVariable["storage_locked", 1]) == 0)']];
