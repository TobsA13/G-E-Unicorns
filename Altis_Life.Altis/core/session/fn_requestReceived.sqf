...
{   
    switch (true) do {
        case (__GETC__(life_coplevel) == 1): {
                ...
                vas_items = ["ItemMap","ItemCompass","Binocular","ItemGPS","muzzle_snds_L","FirstAidKit","Medikit","NVGoggles","U_Rangemaster","H_HelmetB_plain_mcamo","H_Booniehat_mcamo","H_MilCap_mcamo","H_HelmetSpecB_blk","V_Rangemaster_belt","V_PlateCarrier2_rgr","V_RebreatherB","V_RebreatherB","V_TacVest_blk_POLICE","V_PlateCarrierIA1_dgtl"];
        ...
        case (__GETC__(life_coplevel) == 2): {
                ...
                vas_items = ["ItemMap","ItemCompass","Binocular","ItemGPS","muzzle_snds_L","FirstAidKit","Medikit","NVGoggles","optic_MRD","U_Rangemaster","U_B_CombatUniform_mcam_worn","H_HelmetB_plain_mcamo","H_Booniehat_mcamo","H_MilCap_mcamo","H_HelmetSpecB_blk","V_Rangemaster_belt","V_PlateCarrier2_rgr","V_RebreatherB","V_RebreatherB","V_TacVest_blk_POLICE","V_PlateCarrierIA1_dgtl"];
                vas_glasses = ["G_Shades_Black","G_Shades_Blue","G_Sport_Blackred","G_Sport_Checkered","G_Sport_Blackyellow","G_Sport_BlackWhite","G_Aviator","G_Squares","G_Lowprofile","G_Combat","G_Diving"];
                vas_backpacks = ["B_Kitbag_cbr","B_FieldPack_cbr","B_AssaultPack_cbr","B_Bergen_sgg","B_Carryall_cbr","B_Bergen_blk"];		
        ...
        case (__GETC__(life_coplevel) == 5): {
                ...
                vas_items = ["ItemMap","ItemCompass","Binocular","ItemGPS","muzzle_snds_L","FirstAidKit","Medikit","NVGoggles","optic_MRD","optic_Holosight","optic_Aco","optic_Arco","U_Rangemaster","U_B_CombatUniform_mcam_worn","H_HelmetB_plain_mcamo","H_Booniehat_mcamo","H_MilCap_mcamo","H_HelmetSpecB_blk","V_Rangemaster_belt","V_PlateCarrier2_rgr","V_RebreatherB","V_RebreatherB","V_TacVest_blk_POLICE","V_PlateCarrierIA1_dgtl"];
                vas_glasses = ["G_Shades_Black","G_Shades_Blue","G_Sport_Blackred","G_Sport_Checkered","G_Sport_Blackyellow","G_Sport_BlackWhite","G_Aviator","G_Squares","G_Lowprofile","G_Combat","G_Diving"];
                vas_backpacks = ["B_Kitbag_cbr","B_FieldPack_cbr","B_AssaultPack_cbr","B_Bergen_sgg","B_Carryall_cbr","B_Bergen_blk"];		
        ...
        case (__GETC__(life_coplevel) == 7): {
                ...
                vas_items = ["ItemMap","ItemCompass","Binocular","ItemGPS","muzzle_snds_L","FirstAidKit","Medikit","NVGoggles","optic_MRD","optic_Holosight","optic_Aco","optic_Arco","U_Rangemaster","U_B_CombatUniform_mcam_worn","H_HelmetB_plain_mcamo","H_Booniehat_mcamo","H_MilCap_mcamo","H_HelmetSpecB_blk","V_Rangemaster_belt","V_PlateCarrier2_rgr","V_RebreatherB","V_RebreatherB","V_TacVest_blk_POLICE","V_PlateCarrierIA1_dgtl"];
                vas_glasses = ["G_Shades_Black","G_Shades_Blue","G_Sport_Blackred","G_Sport_Checkered","G_Sport_Blackyellow","G_Sport_BlackWhite","G_Aviator","G_Squares","G_Lowprofile","G_Combat","G_Diving","U_Rangemaster","U_B_CombatUniform_mcam_worn","H_HelmetB_plain_mcamo","H_Booniehat_mcamo","H_MilCap_mcamo","H_HelmetSpecB_blk","V_Rangemaster_belt","V_PlateCarrier2_rgr","V_RebreatherB","V_RebreatherB","V_TacVest_blk_POLICE","V_PlateCarrierIA1_dgtl"];
                vas_backpacks = ["B_Kitbag_cbr","B_FieldPack_cbr","B_AssaultPack_cbr","B_Bergen_sgg","B_Carryall_cbr","B_Bergen_blk"];		
        ...
        case (__GETC__(life_coplevel) > 9): {
                ...
                vas_items = ["ItemMap","ItemCompass","Binocular","ItemGPS","muzzle_snds_L","FirstAidKit","Medikit","NVGoggles","optic_MRD","optic_Holosight","optic_Aco","optic_Arco","optic_DMS","optic_LRPS","U_Rangemaster","U_B_CombatUniform_mcam_worn","H_HelmetB_plain_mcamo","H_Booniehat_mcamo","H_MilCap_mcamo","H_HelmetSpecB_blk","V_Rangemaster_belt","V_PlateCarrier2_rgr","V_RebreatherB","V_RebreatherB","V_TacVest_blk_POLICE","V_PlateCarrierIA1_dgtl"];
                vas_glasses = ["G_Shades_Black","G_Shades_Blue","G_Sport_Blackred","G_Sport_Checkered","G_Sport_Blackyellow","G_Sport_BlackWhite","G_Aviator","G_Squares","G_Lowprofile","G_Combat","G_Diving"];
                vas_backpacks = ["B_Kitbag_cbr","B_FieldPack_cbr","B_AssaultPack_cbr","B_Bergen_sgg","B_Carryall_cbr","B_Bergen_blk"];		
