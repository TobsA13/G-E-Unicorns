...
if(playerSide == west) then {
	...
	_Btn4 buttonSetAction "[life_vInact_curTarget] spawn life_fnc_impoundActionADAC;";
	if(!((getMarkerPos "adac_1" distance player < 20) || (getMarkerPos "adac_2" distance player < 20) || (getMarkerPos "adac_3" distance player < 20))) then 
	{ _Btn4 ctrlEnable false; } else { _Btn4 ctrlEnable true; };
