...
if (count life_houses > 9) exitWith {hint "Du darfs nur 10 Häuser besitzen!";};
...
_house setVariable["life_homeOwnerName", [player getVariable["realname",name player]], true];
