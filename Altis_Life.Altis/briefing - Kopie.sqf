	...
	player createDiaryRecord["fine",
		[
			...
			"
				...
				- Besitz von verbotenen Waffen: 15.000$<br/>
				- Besitz von Polizei-Waffen: 35.000$<br/>
				- Schusswaffengebrauch innerhalb von Städten: 10.000$<br/>
				- Führen eines gestohlenen Polizei Fahrzeuges: 50.000$<br/><br/>
				
				Personen & Gegenstände:<br/>
				- Verursachen von Sachschäden: 5.000$<br/>
				- Sich als Polizist aus geben: 10.000$<br/>
				- Anschießen von Personen: 10.000$<br/>
				- Überfall auf Personen:: 10.000$<br/>
				- Mord einer Person: 50.000 + Inhaftierung 30Min<br/><br/>
				...
				- Bankraub (erfolglos): 65.000$ je Teilnehmer<br/>
				...
				- Besitz von Schildkröten: Inhaftierung 10Min<br/><br/>
			"
		]
	];
	player createDiaryRecord["fine",
	...
	player createDiaryRecord["fine",
		[
			...
			"
				...
				- Fliegen in einer Flugverbotszone (Polizei-HQ): 50.000$<br/>
				- Landen auf einer Straße (ohne Aufforderung) 10.000$<br/>
				- Fliegen ohne Kollisionslichter: 6.000$<br/>
				- Fliegen unter 150m über einer Stadt: 10.000$<br/><br/>
			"
		]
	];
	player createDiaryRecord["fine",
	...
	player createDiaryRecord["fine",
		[
			...
			"
				...
				- Wiederholte Missachtung Anordnung: 5.000$ + Inhaftierung 3min<br/>
				...
				- Beschuss von einen Polizeibeamten: 10.000$<br/>
	...
	player createDiaryRecord["fine",
		[
			...
			"
				...
				- Versuchter Diebstahl zivilen Fahrzeuges: 2.500$<br/>
				- Diebstahl zivilen Fahrzeuges: 5.000$<br/>
